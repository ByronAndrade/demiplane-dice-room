...
const messages = {
  "pt-BR": {
    ...
    showOwnRollsLabel: "Mostrar alertas das minhas rolagens",
    showOwnRollsHelp: "O Demiplane ja mostra sua rolagem; deixe desligado para ocultar alertas das suas rolagens. O historico da mesa continua registrando tudo.",
  ...
  en: {
    ...
    showOwnRollsLabel: "Show alerts for my rolls",
    showOwnRollsHelp: "Demiplane already shows your roll; leave this off to hide alerts for your own rolls. Table history still records everything.",
